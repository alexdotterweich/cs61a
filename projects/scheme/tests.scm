...
(define (fizzbuzz x)
  (cond ((and (= 0 (modulo x 3)) (= 0 (modulo x 5))) 
    'fizzbuzz)
        ((= 0 (modulo x 3))
    'fizz)
        ((= 0 (modulo x 5))
...
(filter greater-than-zero? '(-4 0 1 5))
; expect (1 5)
...
; expect sum-every-other

(sum-every-other '(1 2 4 5 6 7 8))
; expect 19
...
(define (sublists lst)
  (if (null? lst)
      '(()) 
      (let ((without-first (sublists (cdr lst)))
            (first (car lst)))
        (append without-first
                (add-to-all first without-first) )) ))
; expect sublists

(sublists '(1 2 3))
; expect (() (3) (2) (2 3) (1) (1 3) (1 2) (1 2 3))

(define (x f g) (* f g x))
; expect x

(define (multi_true n)
  (cond ((> n 0) (print 1) (print 2) (print 3))
    (else (print 4))))
; expect multi_true
...
(begin (+ 2 3) (+ 3 4) (/ 1 1) (* 2 2))
; expect 4

(begin (begin (begin (* 5 6))))
; expect 30

(begin (begin (print 5) (begin (print 6) (begin (print 7) (begin (* 8 1))))))
; expect 5 ; 6 ; 7 ; 8
...
(x 3 4 5 3)
; expect Error: different number of formal parameters and arguments
